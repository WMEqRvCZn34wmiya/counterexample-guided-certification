exp_datasets = [concrete_config_small]
...
exp_lconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(1), >=, 150.0)),
        Atom(ScalarCondition(VariableValue(1), <=, 200.0)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(1), >=, 150.0)),
        Atom(ScalarCondition(VariableValue(1), <=, 200.0)),
        Atom(ScalarCondition(VariableValue(2), >=, 10.0)),
    ...
    CONJUNCTION(
        ...
        Atom(ScalarCondition(VariableValue(2), >=, 10.0)),
        Atom(ScalarCondition(VariableValue(2), <=, 100.0)),
        Atom(ScalarCondition(VariableValue(4), >=, 200.0)),
        Atom(ScalarCondition(VariableValue(4), <=, 230.0)),
    ),
]
...
exp_rconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(0, "Or"), >=, 45.0)),
        Atom(ScalarCondition(VariableValue(0, "Or"), <=, 48.0)),
    ),
]
