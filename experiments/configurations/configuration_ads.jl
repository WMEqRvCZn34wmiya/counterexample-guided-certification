...
exp_lconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(1), >=, 7.4)),
        Atom(ScalarCondition(VariableValue(1), <=, 7.7)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(1), >=, 7.4)),
        Atom(ScalarCondition(VariableValue(1), <=, 7.7)),
        Atom(ScalarCondition(VariableValue(2), >=, 16.1)),
        Atom(ScalarCondition(VariableValue(2), <=, 16.5)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(1), >=, 7.4)),
        Atom(ScalarCondition(VariableValue(1), <=, 7.7)),
        Atom(ScalarCondition(VariableValue(2), >=, 16.1)),
        Atom(ScalarCondition(VariableValue(2), <=, 16.5)),
        Atom(ScalarCondition(VariableValue(3), >=, 75.1)),
        Atom(ScalarCondition(VariableValue(3), <=, 75.4)),
    ),
]
...
exp_rconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(0, "Or"), >=, 25.5)),
        Atom(ScalarCondition(VariableValue(0, "Or"), <=, 25.8)),
    ),
]
