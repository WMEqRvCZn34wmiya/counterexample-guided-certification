exp_datasets = [hayes_roth_config_small]
...
exp_lconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(5), >=, 2)),
        Atom(ScalarCondition(VariableValue(5), <=, 2)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(5), >=, 2)),
        Atom(ScalarCondition(VariableValue(5), <=, 2)),
        Atom(ScalarCondition(VariableValue(4), >=, 1)),
        Atom(ScalarCondition(VariableValue(4), <=, 1)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(5), >=, 2)),
        ...
        Atom(ScalarCondition(VariableValue(4), >=, 1)),
        Atom(ScalarCondition(VariableValue(4), <=, 1)),
        Atom(ScalarCondition(VariableValue(3), >=, 1)),
        Atom(ScalarCondition(VariableValue(3), <=, 1)),
    ),
]
