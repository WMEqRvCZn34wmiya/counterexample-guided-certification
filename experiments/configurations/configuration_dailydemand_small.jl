exp_datasets = [dailydemand_config_small]
...
exp_lconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(1), >=, 60.0)),
        Atom(ScalarCondition(VariableValue(1), <=, 90.0)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(1), >=, 60.0)),
        Atom(ScalarCondition(VariableValue(1), <=, 90.0)),
        Atom(ScalarCondition(VariableValue(2), >=, 100.0)),
        Atom(ScalarCondition(VariableValue(2), <=, 110.0)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(1), >=, 60.0)),
        Atom(ScalarCondition(VariableValue(1), <=, 90.0)),
        Atom(ScalarCondition(VariableValue(2), >=, 100.0)),
        Atom(ScalarCondition(VariableValue(2), >=, 100.0)),
        Atom(ScalarCondition(VariableValue(3), <=, 39.0)),
        Atom(ScalarCondition(VariableValue(3), <=, 47.0)),
    ),
]
...
exp_rconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(0, "Or"), >=, 350.0)),
        Atom(ScalarCondition(VariableValue(0, "Or"), <=, 370.0)),
    ),
]
