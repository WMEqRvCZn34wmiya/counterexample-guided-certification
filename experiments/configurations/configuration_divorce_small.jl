exp_datasets = [divorce_config_small]
...
exp_lconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(54), >=, 0)),
        Atom(ScalarCondition(VariableValue(54), <=, 0)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(54), >=, 2)),
        Atom(ScalarCondition(VariableValue(54), <=, 2)),
        Atom(ScalarCondition(VariableValue(53), >=, 2)),
        Atom(ScalarCondition(VariableValue(53), <=, 2)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(54), >=, 1)),
        Atom(ScalarCondition(VariableValue(54), <=, 1)),
        Atom(ScalarCondition(VariableValue(53), >=, 1)),
        Atom(ScalarCondition(VariableValue(53), <=, 1)),
        Atom(ScalarCondition(VariableValue(52), >=, 1)),
        Atom(ScalarCondition(VariableValue(52), <=, 1)),
    ),
]
