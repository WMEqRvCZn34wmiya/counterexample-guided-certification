exp_datasets = [realestate_config]
...
exp_lconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(3), >=, 23.5)),
        Atom(ScalarCondition(VariableValue(3), <=, 48.0)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(3), >=, 23.5)),
        Atom(ScalarCondition(VariableValue(3), <=, 48.0)),
        Atom(ScalarCondition(VariableValue(1), >=, 2013.1)),
        Atom(ScalarCondition(VariableValue(1), <=, 2013.15)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(3), >=, 23.5)),
        Atom(ScalarCondition(VariableValue(3), <=, 48.0)),
        Atom(ScalarCondition(VariableValue(1), >=, 2013.01)),
        Atom(ScalarCondition(VariableValue(1), <=, 2013.05)),
        Atom(ScalarCondition(VariableValue(2), >=, 42.8)),
        Atom(ScalarCondition(VariableValue(2), <=, 43.7)),
    ),
]
...
exp_rconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(0, "Or"), >=, 78.3)),
        Atom(ScalarCondition(VariableValue(0, "Or"), <=, 117.5)),
    ),
]
