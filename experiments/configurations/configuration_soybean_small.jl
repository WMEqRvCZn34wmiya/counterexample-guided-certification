exp_datasets = [soybean_small_config]
...
exp_lconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(35), >=, 1)),
        Atom(ScalarCondition(VariableValue(35), <=, 1)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(35), >=, 1)),
        Atom(ScalarCondition(VariableValue(35), <=, 1)),
        Atom(ScalarCondition(VariableValue(34), >=, 0)),
        Atom(ScalarCondition(VariableValue(34), <=, 0)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(35), >=, 1)),
        ...
        Atom(ScalarCondition(VariableValue(34), >=, 0)),
        Atom(ScalarCondition(VariableValue(34), <=, 0)),
        Atom(ScalarCondition(VariableValue(33), >=, 0)),
        Atom(ScalarCondition(VariableValue(33), <=, 0)),
    ),
]
...
exp_rconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(0, "Or"), >=, 4)),
        Atom(ScalarCondition(VariableValue(0, "Or"), <=, 4)),
    ),
]
