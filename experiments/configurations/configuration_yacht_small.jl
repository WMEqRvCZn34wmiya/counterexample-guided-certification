exp_datasets = [yacht_config_small]
...
exp_lconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(1), >=, 0.54)),
        Atom(ScalarCondition(VariableValue(1), <=, 0.55)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(1), >=, 0.54)),
        Atom(ScalarCondition(VariableValue(1), <=, 0.55)),
        Atom(ScalarCondition(VariableValue(2), >=, 4.7)),
        Atom(ScalarCondition(VariableValue(2), <=, 4.85)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(1), >=, 0.54)),
        Atom(ScalarCondition(VariableValue(1), <=, 0.55)),
        Atom(ScalarCondition(VariableValue(2), >=, 4.7)),
        Atom(ScalarCondition(VariableValue(2), <=, 4.85)),
        Atom(ScalarCondition(VariableValue(3), >=, 3.35)),
        Atom(ScalarCondition(VariableValue(3), <=, 3.8)),
    ),
]
...
exp_rconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(0, "Or"), >=, 5.6)),
        Atom(ScalarCondition(VariableValue(0, "Or"), <=, 5.9)),
    ),
]
