exp_datasets = [forestfires_config_small]
...
exp_lconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(1), >=, 90.7)),
        Atom(ScalarCondition(VariableValue(1), <=, 91.5)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(1), >=, 90.7)),
        Atom(ScalarCondition(VariableValue(1), <=, 91.5)),
        Atom(ScalarCondition(VariableValue(2), >=, 75.0)),
        Atom(ScalarCondition(VariableValue(2), <=, 85.0)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(1), >=, 90.7)),
        Atom(ScalarCondition(VariableValue(1), <=, 91.5)),
        Atom(ScalarCondition(VariableValue(2), >=, 75.0)),
        Atom(ScalarCondition(VariableValue(2), <=, 85.0)),
        Atom(ScalarCondition(VariableValue(3), >=, 590.0)),
        Atom(ScalarCondition(VariableValue(3), <=, 610.0)),
    ),
]
...
exp_rconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(0, "Or"), >=, 4.5)),
        Atom(ScalarCondition(VariableValue(0, "Or"), <=, 5.0)),
    ),
]
