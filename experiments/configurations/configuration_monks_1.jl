...
exp_lconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(6), >=, 1.3)),
        Atom(ScalarCondition(VariableValue(6), <=, 1.8)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(6), >=, 1.3)),
        Atom(ScalarCondition(VariableValue(6), <=, 1.8)),
        Atom(ScalarCondition(VariableValue(5), >=, 1.3)),
        Atom(ScalarCondition(VariableValue(5), <=, 1.8)),
    ),
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(6), >=, 1.3)),
        Atom(ScalarCondition(VariableValue(6), <=, 1.8)),
        Atom(ScalarCondition(VariableValue(5), >=, 1.3)),
        Atom(ScalarCondition(VariableValue(5), <=, 1.8)),
        Atom(ScalarCondition(VariableValue(4), >=, 1.3)),
        Atom(ScalarCondition(VariableValue(4), <=, 1.8)),
    ),
]
...
exp_rconstraints = [
    CONJUNCTION(
        Atom(ScalarCondition(VariableValue(0, "Or"), >=, 1.3)),
        Atom(ScalarCondition(VariableValue(0, "Or"), <=, 1.8)),
    ),
]
